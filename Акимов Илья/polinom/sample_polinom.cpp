...
int main()
{
	...
	{
		double a;
		cout << "Вводите полиномы от трёх переменных (x,y,z)" << endl;
		cout << "Значение степени вводите через ^ (в диапазоне [0,10) - целые числа)" << endl << endl;
		...
		cout << "Результат вычитания второго полинома из первого: " << result2.toString() << endl;
		cout << "Результат умножения полиномов: " << result3.toString() << endl;
		cout << "Результат умножения первого полинома на константу: " << result4.toString() << endl;
	}
